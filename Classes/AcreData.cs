...
namespace ACSE
{
    class AcreData
    {
        ...
        public static Dictionary<ushort, string> Acres = new Dictionary<ushort, string>()
        {
            ...
            {0x0271, "River (Upper Straight) w/ Stone Bridge" },
            ...
            {0x0289, "Empty Acre (Upper) (8)" },
            {0x028C, "Empty Acre (Lower) (8)" },
            {0x028D, "Empty Acre (Upper) (9)" },
            {0x0290, "Empty Acre (Lower) (9)" },
            {0x0291, "Empty Acre (Upper) (10)" },
            {0x0295, "Dump (2)" },
            {0x0299, "Dump (3)" },
