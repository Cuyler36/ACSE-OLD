...
namespace Animal_Crossing_GCN_Save_Editor
{
    public class ItemData
    {
        ...
        public static ushort[] Furniture_IDs = new ushort[836]
        {
        ...
        public static string getItemType(ushort ID)
        {
            ...
            if ((ID >= 0x5 && ID <= 0x7) || (ID >= 0xB && ID <= 0x10) || (ID >= 0x5000 && ID <= 0xB000)) return "building";
