...
namespace ACSE
{
    public class ItemData
    {
        ...
        public static string GetItemName(ushort itemID)
        {
            ...
            if (itemID < 0xF000 && (itemType == 1 || itemType == 2))
